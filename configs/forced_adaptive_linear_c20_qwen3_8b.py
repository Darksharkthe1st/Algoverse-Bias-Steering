"""Forced-contrast opinion vector via adaptive-LINEAR steering, coeff=20, qwen3-8b.
...
Qwen3 thinking OFF + max_tokens=512 (the truncation-bug fix).
    ...
    python -m src.bias_steer run configs/forced_adaptive_linear_c20_qwen3_8b.py
...
config = ExperimentConfig(
    label="forced-adaptive-linear-c20 qwen3-8b",
    models=["qwen3-8b"],
    dataset=DatasetSpec(
        name="snapshot",
